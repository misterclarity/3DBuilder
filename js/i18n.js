...
(function () {
  ...
  var dict = {
    en: {
      ...
      'set.title': 'Settings', 'set.endpoint': 'AI endpoint (OpenAI-compatible base URL)', 'set.model': 'Model name',
    ...
    de: {
      ...
      'set.title': 'Einstellungen', 'set.endpoint': 'KI-Endpunkt (OpenAI-kompatible Basis-URL)', 'set.model': 'Modellname',
