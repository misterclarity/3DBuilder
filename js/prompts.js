...
(function () {
  ...
  function systemPrompt(lang) {
    var p = [
      ...
      '- Holes and cutouts (bowl cutouts, hand slots, cable holes) MUST be modeled in the part\'s "cutouts" field',
      '  AND have a matching drill/route prep operation. A hole that exists only as a prep instruction is invisible.',
      '- Slanted surfaces: whatever supports a slanted panel must follow the SAME angle — give the rails/frame the',
      '  same rotation, or specify angled cuts on the leg tops as prep operations. NEVER rest a rotated panel on a',
